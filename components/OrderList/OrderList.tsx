...
import type { IOrderListProps } from "@/types/order";
...
function getTime(date: Date) {
  ...
  let time: any = `${hours}:${minutes}:${seconds}`;
...
export default function OrderList({ item, onPress }: IOrderListProps) {
  ...
  useEffect(() => {
    ...
    setTotalCost(
      item?.items.reduce((accumulator: number, object) => {
